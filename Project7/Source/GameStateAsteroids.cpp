...
// Private Variables:
//------------------------------------------------------------------------------
GameObjectPtr newAsteroidSpaceshipObj;
...
{
	newAsteroidSpaceshipObj = GameObjectFactoryBuild("Spaceship");
	if(newAsteroidSpaceshipObj != NULL)
	{
		GameObjectManagerAdd(newAsteroidSpaceshipObj);
	}
