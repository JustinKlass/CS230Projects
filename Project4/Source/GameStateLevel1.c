...
{
	newPlanetObj = GameObjectFactoryBuild("./Data/PlanetBounce.txt");
	newMonkeyObj = GameObjectFactoryBuild("./Data/Monkey.txt");
	...
	if(newMonkeyObj != NULL)
	{
		...
		newLivesObj = GameObjectFactoryBuild("./Data/MonkeyLivesText.txt");
	}
