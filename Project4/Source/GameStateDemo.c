...
void GameStateDemoInit()
{
	...
	//--------------------------------------------------------------------------
	obj1X = 0.0f, obj1Y = 0.0f;		// Position variables for object 1
	obj1texX = 0, obj1texY = 0;		// Texture variables for object 2's texture
	alpha = 1.0f;
	camX = 0;
	camY = 0;
	...
	pTex2 = AEGfxTextureLoadFromMemory(colors, 2, 2);
	AE_WARNING_MESG(pTex2, "Failed to create texture...");
