...
{
	newSpaceshipObj = GameObjectFactoryBuild("SpaceshipOmega");
	...
	newAsteroidScoreObj = GameObjectFactoryBuild("OmegaScore");
	if (newAsteroidScoreObj != NULL)
	{
		GameObjectManagerAdd(newAsteroidScoreObj);
	}

	newAsteroidHighScoreObj = GameObjectFactoryBuild("OmegaHighScore");
	if (newAsteroidHighScoreObj != NULL)
	{
		GameObjectManagerAdd(newAsteroidHighScoreObj);
	}

	newAsteroidWaveObj = GameObjectFactoryBuild("OmegaWave");
